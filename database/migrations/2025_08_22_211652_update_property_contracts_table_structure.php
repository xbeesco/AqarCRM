...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('property_contracts', function (Blueprint $table) {
            ...
            $table->date('contract_date')->after('property_id');
            $table->enum('payment_frequency', ['monthly', 'quarterly', 'four_monthly', 'semi_annually', 'annually'])
                  ->default('monthly')->after('commission_rate');
            $table->string('contract_file')->nullable()->after('payment_frequency');
    ...
    public function down(): void
    {
        Schema::table('property_contracts', function (Blueprint $table) {
            ...
            // حذف الحقول الجديدة
            $table->dropColumn(['contract_date', 'payment_frequency', 'contract_file']);
