...
class UnitFeatureSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        \App\Models\UnitFeature::truncate();
        
        // إعادة تفعيل فحص المفاتيح الأجنبية
        \DB::statement('SET FOREIGN_KEY_CHECKS=1;');
        
        $features = [
            // أساسيات (Basic Features)
            [
                'name_ar' => 'غرف نوم',
                'name_en' => 'Bedrooms',
                'slug' => 'bedrooms',
                ...
                'description_ar' => 'عدد غرف النوم في الوحدة',
                'description_en' => 'Number of bedrooms in the unit',
                'requires_value' => true,
                'value_type' => 'number',
                'value_options' => null,
                'is_active' => true,
            ...
            [
                ...
                'description_ar' => 'عدد الحمامات في الوحدة',
                'description_en' => 'Number of bathrooms in the unit',
                'requires_value' => true,
                'value_type' => 'number',
                'value_options' => null,
                'is_active' => true,
            ...
            [
                ...
                'description_ar' => 'مساحة الوحدة بالمتر المربع',
                'description_en' => 'Unit area in square meters',
                'requires_value' => true,
                'value_type' => 'number',
                'value_options' => null,
                'is_active' => true,
            ...
            [
                ...
                'description_ar' => 'رقم الطابق للوحدة',
                'description_en' => 'Floor number of the unit',
                'requires_value' => true,
                'value_type' => 'number',
                'value_options' => null,
                'is_active' => true,
